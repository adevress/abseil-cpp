...
if(NOT ABSL_ENABLE_BUNDLE)
    ...
    if(NOT CCTZ_FOUND)
        ...
        ExternalProject_Add(CCTZ_BUNDLE
            ...
            BUILD_COMMAND "make" "PREFIX=${CCTZ_BUNDLE_INTERNAL_INSTALLDIR}" "CXX=${CMAKE_CXX_COMPILER}" "CC=${CMAKE_C_COMPILER}"
            BUILD_IN_SOURCE 1
            INSTALL_DIR "${CCTZ_BUNDLE_INTERNAL_INSTALLDIR}"
            INSTALL_COMMAND "make" "install" "PREFIX=${CCTZ_BUNDLE_INTERNAL_INSTALLDIR}" "CXX=${CMAKE_CXX_COMPILER}" "CC=${CMAKE_C_COMPILER}"
            LOG_DOWNLOAD 1
            LOG_BUILD 1
         )
