...
function(absl_library)
  ...
  if((NOT ${ABSL_LIB_DISABLE_INSTALL}) AND (NOT ${ABSL_DISABLE_INSTALL}))
...
#
# install headers under a given prefix

function(absl_header_install)
  cmake_parse_arguments(ABSL_HINSTALL
    ""
    "PREFIX"
    "HEADERS"
    ${ARGN}
  ...
  if(NOT ${ABSL_DISABLE_INSTALL})
    install(FILES ${ABSL_HINSTALL_HEADERS} DESTINATION ${CMAKE_INSTALL_FULL_INCLUDEDIR}/absl/${ABSL_HINSTALL_PREFIX})
  endif()
endfunction()


# generate pkgconfig file
function(absl_pkgconf_generate)
  set(SRC_PKG_CONFIG_IN ${_ABSL_HELPERS_PATH}/absl.pc.in)
